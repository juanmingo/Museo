...
@NamedQueries({
    ...
    , @NamedQuery(name = "CarreraImparte.findByCodSedeImparte", query = "SELECT c FROM CarreraImparte c WHERE c.sedCodSede.sedCodSede = :codSedeImparte AND c.carreraImpartePK.codMencion = 0 AND c.carreraImpartePK.codCarrera NOT IN (0,90,99)  ORDER BY c.carreraSede.nomCarrera")
